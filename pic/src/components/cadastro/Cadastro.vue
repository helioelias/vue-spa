<template>
  ...
  <div>
    <h2 class="centalizado">Cadastro</h2>
    ...
    <form @submit.prevent="grava">
      ...
      <div class="controle">
        ...
        <input name="url" v-validate data-vv-rules="required|min:3|max:30" id="url" autocomplete="off" v-model="foto.url">
      ...
      <div class="centralizado">
        ...
        <router-link :to="{ name:'home' }"><meu-botao rotulo="VOLTAR" tipo="button"></meu-botao></router-link>
      </div>
